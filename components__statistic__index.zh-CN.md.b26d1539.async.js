"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[3005],{513555:function(Z,a,l){l.r(a);var c=l(502143),v=l(968521),m=l(720719),p=l(28840),x=l(759907),u=l(828089),C=l(825673),E=l(902068),h=l(574399),P=l(863942),f=l(316073),D=l(24628),O=l(719260),g=l(956140),i=l(127179),o=l(905388),U=l(104979),A=l(606965),M=l(268696),e=l(424128),W=l(249706),R=l(795127),T=l(116846),I=l(73024),s=l(606641),_=l(667294),t=l(370917);function d(){var r=(0,s.eL)(),n=r.texts;return(0,t.tZ)(s.dY,null,(0,t.tZ)(_.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,t.tZ)(e.Z,{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528",sourceType:"a"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,n[1].value),(0,t.tZ)("li",null,n[2].value)),(0,t.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,t.tZ)(e.Z,{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A",sourceType:"a"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,t.tZ)(o.Z,{items:[{demo:{id:"components-statistic-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/statistic/demo/basic.tsx",jsx:`import { Button, Col, Row, Statistic } from 'antd';
const App = () => (
  <Row gutter={16}>
    <Col span={12}>
...
export default App;
`,description:"<p>\u5012\u8BA1\u65F6\u7EC4\u4EF6\u3002</p>"}},{demo:{id:"components-statistic-demo-component-token"},previewerProps:{debug:!0,title:"\u7EC4\u4EF6 Token",filename:"components/statistic/demo/component-token.tsx",jsx:`import { Button, Col, ConfigProvider, Row, Statistic } from 'antd';
const App = () => (
  <ConfigProvider
    theme={{
      components: {
