"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[1185],{952243:function(Z,d,t){t.r(d);var h=t(502143),v=t(968521),_=t(720719),m=t(28840),u=t(759907),a=t(828089),y=t(825673),f=t(902068),x=t(574399),k=t(863942),g=t(316073),D=t(24628),E=t(719260),O=t(956140),i=t(127179),r=t(905388),K=t(104979),T=t(606965),w=t(268696),l=t(424128),P=t(249706),b=t(795127),S=t(116846),I=t(73024),o=t(606641),s=t(667294),e=t(370917);function c(){var p=(0,o.eL)(),n=p.texts;return(0,e.tZ)(o.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)(l.Z,{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use",sourceType:"a"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value,(0,e.tZ)("code",null,n[2].value),n[3].value,(0,e.tZ)("code",null,n[4].value),n[5].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)(l.Z,{"aria-hidden":"true",tabIndex:"-1",href:"#examples",sourceType:"a"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(r.Z,{items:[{demo:{id:"components-tree-demo-basic"},previewerProps:{title:"Basic",filename:"components/tree/demo/basic.tsx",jsx:`import { Tree } from 'antd';
const treeData = [
  {
    title: 'parent 1',
    key: '0-0',
